...
export default Ember.Route.extend({
  model: function(params) {
    ...
    var url = 'https://api.foursquare.com/v2/venues/explore?near=' + location + '&categoryId=4d4b7105d754a06376d81259&limit=25&client_id=' + CLIENT_ID + '&client_secret=' + CLIENT_SECRET + '&v=20171003';
